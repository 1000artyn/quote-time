...
class QuoteController extends Controller
{
    public function aurelius()
    {
        ...
        return view('aurelius', [
            'quote' => $randomQuote,
            'quotes' => $quotes   // pass all quotes for JS random button
        ]);
    }
    public function confucius()
    {
        $quotes = [
